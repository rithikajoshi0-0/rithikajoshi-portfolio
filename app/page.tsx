    ...
    <header className="sticky top-0 z-30 border-b border-slate-800/80 bg-slate-950/70 backdrop-blur supports-[backdrop-filter]:bg-slate-950/50">
      <nav className="mx-auto max-w-6xl px-4 h-14 flex items-center justify-between">
        ...
        <ul className="hidden md:flex items-center gap-6 text-sm">
          ...
          <li>
            <a className="text-slate-300 hover:text-cyan-300 transition-colors" href="#galactic-ventures">
              Galactic Ventures
            </a>
          </li>
          <li>
            <a className="text-slate-300 hover:text-cyan-300 transition-colors" href="#skill-constellations">
              Skill Constellations
            </a>
          </li>
          <li>
            <a className="text-slate-300 hover:text-cyan-300 transition-colors" href="#cosmic-connections">
              Cosmic Connections
            </a>
          </li>
        </ul>
    ...
    <section className="relative min-h-[90vh] md:min-h-screen overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-4 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
        <div className="py-16 md:py-0">
          ...
          <h1 className="text-balance mt-3 text-3xl md:text-5xl font-semibold text-white">
          ...
          <div className="mt-7 flex flex-wrap items-center gap-3">
            <Button asChild>
              <a href="#galactic-ventures" aria-label="Explore projects">
                Explore Projects
              </a>
            </Button>
            <a
              href="#cosmic-connections"
